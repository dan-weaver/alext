      ...
      <div className="header-container">
            ...
            <ul className="nav">
              <li>
                <ul>
                  ...
                  <li>
                    <Link to={"/issues"} onclick="location.href='issues.html'">
                      ISSUES
                    </Link>
                  </li>
                </ul>
              ...
              <li className="social facebook">
                <a href="http://www.facebook.com/AlexTforTexas" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
                    height="30"
        ...
        <header className="mobile">
          <ul className="nav">
            ...
            <li>
              <a href="http://www.alextfortexas.com/#involved">Get Involved</a>
            </li>
            <li>
              <a
